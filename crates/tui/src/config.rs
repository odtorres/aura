...
pub fn theme_light() -> Theme {
    Theme {
        ...
        gutter_fg: Color::Rgb(150, 160, 170),
        status_bg: Color::Rgb(230, 232, 236),
        status_fg: Color::Rgb(36, 41, 46),
        mode_normal: Color::Rgb(0, 92, 197),
        mode_insert: Color::Rgb(34, 134, 58),
        mode_command: Color::Rgb(179, 120, 0),
        mode_visual: Color::Rgb(111, 66, 193),
        mode_intent: Color::Rgb(3, 102, 214),
        mode_review: Color::Rgb(215, 58, 73),
        selection_bg: Color::Rgb(200, 220, 255),
        selection_fg: Color::Rgb(36, 41, 46),
        git_added: Color::Rgb(34, 134, 58),
        git_modified: Color::Rgb(179, 120, 0),
        git_deleted: Color::Rgb(215, 58, 73),
        error: Color::Rgb(215, 58, 73),
        warning: Color::Rgb(179, 120, 0),
        info: Color::Rgb(3, 102, 214),
        keyword: Color::Rgb(167, 29, 93),
        string: Color::Rgb(3, 47, 98),
        comment: Color::Rgb(106, 115, 125),
        function: Color::Rgb(111, 66, 193),
        type_name: Color::Rgb(0, 92, 197),
        number: Color::Rgb(0, 92, 197),
        ghost: Color::Rgb(170, 180, 190),
        author_human: Color::Rgb(34, 134, 58),
        author_ai: Color::Rgb(3, 102, 214),
    }
}
